...
public	static Image img;
    public static ByteArrayInputStream citiesReport(List<Operation> cities , String rib, double solde) {
   
        Document document = new Document();
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        try {
			 img = Image.getInstance("C:\\Users\\HP\\Desktop\\PFE\\iconbangue.PNG");
        ...
        Paragraph releve = new Paragraph("BANQUE EN LIGNE"+"                                                                "+"RELEVE DE COMPTE", font2);
        ...
        Paragraph para7= new Paragraph( "SOLDE"+"  :" +solde+ " "+"MAD", font);
  ...
  para6.add("   "+"Monnaie de compte :MAD");
        ...
        try {
			...
			document.addTitle("Releve de compte");
            document.close();
